...
contract TeslaToken is MintableToken {
  string public constant name = "ETesla";
  string public constant symbol = "ETSLA";
  uint256 public constant decimals = 21;
}

contract TeslaCrowdsale is ExchangeCrowdsale {

  function TeslaCrowdsale(uint256 _startTime, uint256 _endTime, uint256 _rate, uint256 _cap, address _wallet)
